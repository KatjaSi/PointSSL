...
class POINT_SSL2(nn.Module):

    def __init__(self, in_channels=3, output_channels=40):
        super(POINT_SSL2, self).__init__()
        ...
        self.linear1 = nn.Linear(256*4+256*4, 1024, bias=False)     # will concat max pool and avg pool      
       ...
       # self.linear3 = nn.Linear(128, 64) # This representation will go into loss function
        self.projection = ProjectionHead(512) # output is 32
